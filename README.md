...
|---------|--------------|
[![Build Status](https://dev.azure.com/PraveenBadiger/ASP.Net.Core/_apis/build/status/SRSSP.ASP.NET-CORE?branchName=master)](https://dev.azure.com/PraveenBadiger/ASP.Net.Core/_build/latest?definitionId=1?branchName=master)
